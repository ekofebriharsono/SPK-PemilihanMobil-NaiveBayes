			...
			<?php
								...
								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
											...
											echo "<tr><td><b>Jumlah Hasil Perkalian</td>";
											for($i=0; $i<$arl2; $i++){
												echo "<td><b>".$pha[$i]."</td>";
											}
											echo "<td></td></tr>";
								...
								<?php
										...
										for($i=0;$i<$arl2;$i++){ //new for 8 lines below
											if($i==0)
												echo "Dari tabel tersebut dapat disimpulkan bahwa <b>".$wil[array_search((end($pha)), $pha)]."</b> mempunyai hasil paling tinggi, yaitu <b>".current($pha)."</b>";
											elseif($i==$arl2-1)
												echo "</br>Dan terakhir <b>".$wil[array_search((prev($pha)), $pha)]."</b> dengan nilai <b>".current($pha)."</b>.";
											else
