	...
	<div class="container">
	  ...
	  <div class="panel panel-success">
		  ...
		  <div class="panel-body table-responsive">
			<table id="example" border="1" class="table table-striped table-bordered" cellspacing="0" width="100%">
			<thead>
				<tr>
					<th>No.</th>
					<th>Kriteria 1</th>
			...
			<tbody>
										<?php
												...
												while ($row = $kriteria->fetch_assoc()) {
													...
													echo '<td>'.ucwords($row["bobot"]).'x</td>';
													echo '<td>'.ucwords($row["kriteria_2"]).'</td>';
