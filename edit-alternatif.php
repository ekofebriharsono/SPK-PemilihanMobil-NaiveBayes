							...
							<form role="form" method="post" action="edit.php?id=<?php echo $_GET['id'];?>">
										...
										<div class="form-group">
                                            ...
                                            <select class="form-control" name="k1" id="k1">
												<option value='1' <?php if($row["k1"]==1) echo "selected"?>>1 (10 jt sampai 30 jt)</option>
												<option value='2' <?php if($row["k1"]==2) echo "selected"?>>2 (30 jt sampai 50 jt)</option>
												<option value='3' <?php if($row["k1"]==3) echo "selected"?>>3 (50 jt sampai 80 jt)</option>
												<option value='4' <?php if($row["k1"]==4) echo "selected"?>>4 (80 jt sampai 100 jt)</option>
												<option value='5' <?php if($row["k1"]==5) echo "selected"?>>5 (100 jt sampai 150 jt)</option>
												<option value='6' <?php if($row["k1"]==6) echo "selected"?>>6 (150 jt sampai 200 jt)</option>
												<option value='7' <?php if($row["k1"]==7) echo "selected"?>>7 (200 jt sampai 250 jt)</option>
												<option value='8' <?php if($row["k1"]==8) echo "selected"?>>8 (250 jt sampai 450 jt)</option>
												<option value='9' <?php if($row["k1"]==9) echo "selected"?>>9 (450 jt sampai 600 jt)</option>
										    </select>
                                        </div>
										<div class="form-group">
