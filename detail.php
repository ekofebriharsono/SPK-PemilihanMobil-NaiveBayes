	...
	<div class="container">
      ...
      <div class="panel panel-success">
		  ...
		  <div class="panel-body">
			<?php
								$arl = 3;	//array lenght, 4 means ordo for 4x4 matrix
								$alternatif = 0;
								$kri = get_kriteria();
								$alt = get_alternatif();
								$mb = create_mx($kri);
								...
								for($i=0;$i<$arl2;$i++){ //new for 8 lines below
									if($i==0)
										echo "<div class='alert alert-dismissible alert-success'>Dari tabel tersebut dapat disimpulkan bahwa <b>".$wil[array_search((end($pha)), $pha)]."</b> mempunyai hasil paling tinggi, yaitu </b>".current($pha);
									elseif($i==$arl2-1)
										echo "</br>Dan terakhir <b>".$wil[array_search((prev($pha)), $pha)]."</b> dengan nilai <b>".current($pha).".</b></div>";
									else
										echo "</br>Lalu diikuti dengan <b>".$wil[array_search((prev($pha)), $pha)]."</b> dengan nilai <b>".current($pha)."</b>";
								}
